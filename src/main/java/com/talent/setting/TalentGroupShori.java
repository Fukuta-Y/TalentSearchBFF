...
public class TalentGroupShori
{
     ...
     * @return List<TalentShutsuenHonsuDto> タレント出演本数DTOのリスト
     */
    public List<TalentShutsuenHonsuDto> setTalentShutsuenHonsuCountList(
        List<TalentShutsuenHonsuDto> TalentShutsuenHonsuList
    )
    {
        Map<TalentShutsuenHonsuDto, Long> dtoCount = TalentShutsuenHonsuList.stream()
